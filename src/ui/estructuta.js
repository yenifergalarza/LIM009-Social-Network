...
<div class="user-photo-name"><img class="user-photo" src="../controller-firebase/PIRATAS.jpg" alt="">
<div class="text-user">
<p>juanita sanchez</p>
...
<div id="share" class="button-share click white">comparte</div>

</div>
</div>
<div class="comment-post post">
<div class="owner-post">
<h3 class="font-size-post white ">Publicado por Alexandra aguirre</h3>
<div class="cross" id="delete"></div>
</div>
<p class="font-size-post text-post">hola bbcitass</p>
